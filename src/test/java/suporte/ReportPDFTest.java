...
public class ReportPDFTest extends Hooks {
	
	    private static String FILE = "C://Evidences//SecondPdf.pdf";
	    ...
	    private static void addTitlePage(Document document)
	        ...
	        preface.add(new Paragraph(
	                "Report generado por: " + System.getProperty("user.name") + ", Data: " + formatDate("dd/MM/yyyy HH:mm:ss", new Date()) , //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	                smallBold));
